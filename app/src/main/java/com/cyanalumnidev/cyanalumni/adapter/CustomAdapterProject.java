 ...
 */
public class CustomAdapterProject extends RecyclerView.Adapter<CustomAdapterProject.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            textView = (TextView) v.findViewById(R.id.project_title);
            textView2 = (TextView) v.findViewById(R.id.project_desc);
            photo = (ImageView) v.findViewById(R.id.project_pic);
        }
     ...
     */
    public CustomAdapterProject(String[] dataSet,String[] dataSet2, int[] dataSet3) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.project_inner, viewGroup, false);
